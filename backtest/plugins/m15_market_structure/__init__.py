...
15-minute timeframe fractal-based market structure analysis.
"""
...
from .plugin import M15MarketStructurePlugin

# Configure logging
logger = logging.getLogger(__name__)

# Create plugin instance
_plugin = M15MarketStructurePlugin()

# Export the main interface
async def run_analysis(symbol: str, entry_time: datetime, direction: str) -> Dict[str, Any]:
    """
    Run M15 Market Structure analysis.
    ...
    try:
        ...
        logger.info(f"M15 Market Structure analysis complete for {symbol} at {entry_time}")
        return result
        
    except Exception as e:
        logger.error(f"Error in M15 Market Structure analysis: {e}")
        # Return error result
        return {
