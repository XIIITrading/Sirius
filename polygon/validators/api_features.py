# polygon/validators/api_features.py - API endpoint validation
"""
API feature validation for testing Polygon.io endpoint availability.
Complements data quality validation with API functionality tests.
"""
...
class APIFeatureValidator:
    """Tests Polygon API endpoints and features"""
    ...
    async def _validate_reference_data(self) -> Dict[str, Any]:
    ...
    async def _validate_fundamentals(self) -> Dict[str, Any]:
    ...
    async def _validate_corporate_actions(self) -> Dict[str, Any]:
        """Test corporate actions data"""
        return {
            'status': 'skipped',
            'message': 'Test not implemented yet',
            'details': {}
    ...
    async def _validate_technical_indicators(self) -> Dict[str, Any]:
    ...
    async def _validate_minute_aggregates(self) -> Dict[str, Any]:
        """Test minute aggregates"""
        return {
            'status': 'skipped',
            'message': 'Test not implemented yet',
            'details': {}
    ...
    async def _validate_websockets(self) -> Dict[str, Any]:
    ...
    async def _validate_second_aggregates(self) -> Dict[str, Any]:
        """Test second aggregates"""
        return {
            'status': 'skipped',
            'message': 'Test not implemented yet',
            'details': {}
    ...
    async def _validate_trades(self) -> Dict[str, Any]:
    ...
    async def _validate_snapshot(self) -> Dict[str, Any]:
