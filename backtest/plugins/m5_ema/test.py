# backtest/plugins/m5_ema/test.py
"""
Test CLI for M5 EMA Crossover Plugin
...
from backtest.calculations.indicators.m5_ema import M5EMACalculator, validate_5min_data
...
class PluginTester:
    ...
    def __init__(self):
        ...
        logger.info("Initializing M5 EMA Plugin Tester...")
    ...
    async def run_analysis(self, symbol: str, entry_time: datetime, direction: str):
        ...
        """
        logger.info(f"\n{'='*60}")
        logger.info(f"Starting 5-minute EMA analysis for {symbol} at {entry_time}")
        ...
        try:
            ...
            is_valid, error_msg = validate_5min_data(bars_1min)
            if not is_valid:
    ...
    def _format_signal(self, result, entry_time: datetime, direction: str) -> dict:
        ...
        return {
            ...
            'display_data': {
                'summary': f"5-Min EMA 9/21 - {signal_map[result.signal]}",
                ...
                'table_data': [
                    ...
                    ['5m Bars', f'{result.bars_processed}'],
    ...
    def display_results(self, signal: dict):
        ...
        if details:
            ...
            print(f"   5m Bars Processed: {details.get('bars_processed', 'N/A')}")
...
async def main():
    ...
    parser = argparse.ArgumentParser(
        description="Test M5 EMA Crossover Plugin Workflow",
...
if __name__ == "__main__":
    print("\n🚀 M5 EMA Crossover Plugin Test CLI")
