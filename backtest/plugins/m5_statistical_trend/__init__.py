...
Self-contained plugin for higher timeframe trend analysis using statistical methods.
"""
...
from .plugin import M5StatisticalTrendPlugin

# Configure logging
logger = logging.getLogger(__name__)

# Create plugin instance
_plugin = M5StatisticalTrendPlugin()
...
async def run_analysis(symbol: str, entry_time: datetime, direction: str) -> Dict[str, Any]:
    ...
    try:
        ...
        logger.info(f"5-Min Statistical Trend analysis complete for {symbol} at {entry_time}")
        return result
        
    except Exception as e:
        logger.error(f"Error in 5-Min Statistical Trend analysis: {e}")
        # Return error result
        return {
