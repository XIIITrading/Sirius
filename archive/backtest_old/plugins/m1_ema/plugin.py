...
from .adapter import M1EMABackAdapter
from .storage import M1EMAStorage


class M1EMAPlugin(BacktestPlugin):
    """Plugin for 1-minute EMA crossover calculation"""
    ...
    def get_adapter_config(self) -> Dict[str, Any]:
        """Configuration for M1 EMA adapter"""
        return {
    ...
    async def store_results(self, supabase_client, uid: str, signal_data: Dict) -> bool:
        ...
        return await M1EMAStorage.store(supabase_client, uid, signal_data_clean)
